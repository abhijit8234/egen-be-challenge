package com.egenchallenge.dbconfig;
...
public class MongoConfig {
    ...
    public Datastore datastore() throws ClassNotFoundException {
        ...
        for (BeanDefinition candidate : entityScanner.findCandidateComponents("com.egenchallenge.bo")) { // from properties
            morphia.map(Class.forName(candidate.getBeanClassName()));
        }

        return morphia.createDatastore(mongoClient, "dataStore1"); // from properties file
    }
}
